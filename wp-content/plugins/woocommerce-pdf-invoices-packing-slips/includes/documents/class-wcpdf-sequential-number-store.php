...
$sql = "CREATE TABLE {$this->table_name} (
  ...
  PRIMARY KEY  (id)
	...
	public function webtual_credit_notes_increment($order_id = 0, $date = null ) {
		...
		do_action('wpo_wcpdf_before_sequential_number_credit_notes_increment', $this, $order_id, $date );
	...
	public function get_next() {
		...
		if ( $this->method == 'auto_increment' ) {
			...
			$SQL="SELECT * FROM {$this->table_name} WHERE id = ( SELECT MAX(id) from {$this->table_name} )";
