jQuery(document).ready(function($) 
{
    ...
    $(document).on('keyup','input.bulk-tube-price',function(){
        ...
        $(".change-price .single-product").each(function()
        {
            ...
            percentage_price=((tyre_price+tube_price)*parseFloat(flat_percentage))/100;
        ...
        $(".change-price .single-product").each(function()
        {
           // console.log($(this).attr('data-id'));
            ...
            if(tyre_price == ''){
             ...
             percentage_price=((parseFloat(new_tyre_price)+parseFloat(tube_price))*parseFloat(flat_percentage))/100;
           // console.log(tyre_price);
    ...
    $(document).on('keyup','input.tube-price-real',function(){
        ...
        var percentage_price;
        percentage_price=((parseFloat(tyre_price)+parseFloat(tube_price))*parseFloat(flat_percentage))/100;
    ...
    $(document).on('keyup','input.tyre-price-real',function(){
        ...
        if(tube_price>0){
           percentage_price=((parseFloat(tyre_price)+parseFloat(tube_price)) * parseFloat(flat_percentage))/100; 
            ...
            percentage_price=(parseFloat(tyre_price) * parseFloat(flat_percentage))/100;
           }
    ...
    $(document).on('keyup','input.flat_percentage',function(){
        ...
        var percentage_price;
        if(tube_price == '-'){
            percentage_price=((parseFloat(tyre_price))*parseFloat(percentage))/100;
        }else{
            percentage_price=((parseFloat(tyre_price)+parseFloat(tube_price))*parseFloat(percentage))/100;
        }
        var margin_price = $(single_product).find('.margin-price-real').val();
...
jQuery(document).on('change','#brand_name',function()
    {   
        var admin_url = $('.admin-url').text();
