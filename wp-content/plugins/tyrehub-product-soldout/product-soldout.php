...
{
    wp_enqueue_script('tyrehub_admin_soldout_script', plugins_url('/js/sold_out.js', __FILE__), array('jquery'),true);
}
...
<style type="text/css">
    .jconfirm .jconfirm-box{ width: 30%!important; }
    .select-all-data {
    float: right;
    background: green;
    border: none;
		...
		<div class="product-container ">
            ...
            <div class="selected-products"><h2>Selected Product List</h2>
                ...
                ?>
                        ...
                        <table class="form-table" style="width: 96%; display: none;">
                            <tr>
                                <td></td>
...
function soldout_product_list()
{
    ...
    if($flag=='remove'){
        ...
        $wpdb->get_results("DELETE FROM th_soldout_product_list WHERE product_id=".$product_id);
