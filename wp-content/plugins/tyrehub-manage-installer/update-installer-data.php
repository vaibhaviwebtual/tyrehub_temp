...
foreach ($installer_data as $key => $value)
	{
		...
		$is_minifranchise = $value->is_minifranchise;
		$image = $value->image;
		$state = $value->state;
...
?>
	<div class="wrap woocommerce">
 		...
 		<form action="" method="post">
		 	<table class="form-table" >
		 		<tbody>
					...
					<tr>
		 				<th>Mini Franchise</th>
		 				<td>
		 					 <input type="checkbox" class="" name="minifranchise_status"  <?php if($is_minifranchise == 'yes'){ echo 'checked';} ?> />&nbsp;<?php esc_html_e( '
							 Mini Franchise', 'woocommerce' ); ?>
		 				</td>
		 			</tr>
		 			<tr>
 		...
 		if(isset($_POST['update']))
 		{
			...
			if($_POST['minifranchise_status'])
		    {
		         $is_minifranchise = 'yes';
		    }
