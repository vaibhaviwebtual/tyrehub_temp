 	...
 	<table class="form-table" >
 		<tbody>
			...
			<tr>
                ...
                <td> <input type="checkbox" class="" name="minifranchise_status" <?php if($_POST['minifranchise_status']){ echo 'checked';} ?>/></td>
            </tr>
 			<tr>
...
gst_email*/ 
            ...
            $insert = $wpdb->insert('th_installer_data', array(
									...
									'is_minifranchise' => $minifranchise_status,
