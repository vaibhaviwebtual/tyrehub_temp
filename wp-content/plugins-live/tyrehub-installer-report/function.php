         ...
         $loop->the_post();
            ...
            if($order_prd_id == $service_voucher_prd){
                    $service_data = "SELECT * 
                                    ...
                                    WHERE product_id = '$order_prd_id' and installer_id = '$installer_id' and order_id = '$order_id' and status = 'completed' and paid != 'yes' and CONVERT(STR_TO_DATE(substr(completed_date,1,10), '%d-%m-%Y'), DATE) BETWEEN '".$start_date."' AND '".$end_date."'";
            }
            else{
                ...
                $service_data = "SELECT * 
                                ...
                                WHERE product_id = '$order_prd_id' and installer_id = '$installer_id' and order_id = '$order_id' and status = 'completed' and destination = 1 and paid != 'yes' and CONVERT(STR_TO_DATE(substr(completed_date,1,10), '%d-%m-%Y'), DATE) BETWEEN '".$start_date."' AND '".$end_date."' ";


                                /*SELECT * FROM th_cart_item_installer WHERE installer_id = '41' and status = 'completed' and destination = 1 and paid != 'yes' and CONVERT(STR_TO_DATE(substr(completed_date,1,10), '%d-%m-%Y'), DATE) BETWEEN '2019-08-01' AND '2019-09-31'*/ 
