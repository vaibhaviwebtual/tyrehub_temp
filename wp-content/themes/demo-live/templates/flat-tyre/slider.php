				...
				<div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
					<div class="service_filter">
						<div class="title_part">
							...
							<div class="title">Car Flat Tyre / Jump Start</div>
						</div>
						<div class="img_part">
							<img class="normal" src="<?php echo get_stylesheet_directory_uri(); ?>/images/slide-icon/flat_tyre_and_jump_start_img.png" />
						</div>
						<div class="vehicle_part">
							<!--<h3 class="vehicle_title">Select Vehicle</h3>-->
							<form id="flat-typre" action="#" method="post">  
								<div class="service_radio">
									<div class="inputGroup service_type">
										<input type="radio" name="service_type" id="flat_tyre" value="Flat Tyre"/>
										<label for="flat_tyre">Flat Tyre</label>
									</div>
									<div class="inputGroup service_type">
										<input type="radio" name="service_type" id="jump_start" value="Jump Start"/>
										<label for="jump_start">Jump Start</label>
									</div> 
								</div>
