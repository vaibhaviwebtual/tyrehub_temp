...
<tbody>
	...
	<!-- <tr>
				<td colspan="7" style="border: none;">					
					<strong>Vehicle Detail:</strong> <?=$vehicleInfo->model_name;?>, <?=$vehicleInfo->car_number;?>, Odo-<?=$vehicleInfo->odo_meter;?> <br>
					<strong>Tyre Serial Number:</strong> <?php foreach($TyreDetails as $key=>$value){ echo $value->serial_number; echo ', ';} ?>
				<?php
					if($guarantee_text != '')
					{
