		...
		?>
            ...
            //////------- service voucher -----------//
                    ...
                    <div class="service-status-info">
						<strong class="ser-sec-title">Service Details :</strong>
                        <div style="margin-top: 10px;padding-right: 15px;padding-left: 15px;">
                            <b>Service Details</b>
                            <ul>
                                <li>
            ...
            <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content" style="text-align: center;">
                ...
                <div class="modal-footer" style="text-align: center;">
                  <a href="<?php get_site_url(); ?>/my-account/service-request" class="btn btn-invert" style="min-width: 100px; padding: 10px;"><span>ok</span></a>
                </div>
              </div>
