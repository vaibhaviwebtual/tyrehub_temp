...

{
	...
	// insert new record
	$SQL="SELECT COUNT(*) FROM $th_cart_item_installer WHERE cart_item_key = '$cart_item_id' and session_id = '$session_id' and order_id = ''"; //sales@tyrehub.com
