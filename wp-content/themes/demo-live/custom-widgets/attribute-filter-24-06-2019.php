...
class custom_Layered_Nav extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		global $wpdb;
        $SQLTWO="SELECT DISTINCT w_cat_id FROM th_width_display WHERE  two_wheeler='yes'";
		...
		global $wpdb;
        $SQLTWO="SELECT DISTINCT w_cat_id FROM th_width_display WHERE  four_wheeler='yes'";
        $twoRows = $wpdb->get_results($SQLTWO);
