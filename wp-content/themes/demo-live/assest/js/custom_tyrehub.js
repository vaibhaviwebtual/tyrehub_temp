          ...
          var services=$('#services_id').val();
            $.ajax({
              ...
              if(element.is_franchise=='yes'){
                  ...
                  $franchlogo='tyrehub-franchiese.png';
                  $frantitle='<h4>Tyrehub Franchise</h4>';
              }else{
                  $clsss2='';
                  $franchlogo='store.png';
                  $frantitle='';
              }
            ...
            html+='<div class="right">';
                ...
                html+='<img class="aligncenter size-full wp-image-76" src="'+get_stylesheet_directory_uri+'/images/service-icon/store_location.png" alt="">';
                html+='</a>';
                html+='</div>';
                html+='<div class="text-part">';
