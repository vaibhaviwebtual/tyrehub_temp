								...
								<div class="vertical-tab-content active">
									...
									<div class="form-tab byvehicle active">
										<form id="tab1-form">
											...
											<div class="form-group">
												<div class="select-wrapper">
													<select name="vehicle_type_two_model" id="vehicle_type_two_model"  class="input-custom" required>
						 				...
						 				<button class="get-tyre-bymodel-twowheel"><span>Get Tyre Pricing</span></button>
									</div>
									<div class="form-tab bysize">
										<form id="tab1-form">
											...
											<div class="form-group">
												<div class="select-wrapper">
													<select name="vehicle_type_two_size" id="vehicle_type_two_size"  class="input-custom" required>
														<option value="">Select Vehicle Type</option>
														<?php
														global $wpdb;
														$row = $wpdb->get_results("SELECT * FROM th_vehicle_type WHERE wheel_type = '1'");
										...
										<button class="get-tyre-bywidth-twowheel"><span>Get Tyre Pricing</span></button>
									</div>
								</div>
							</div>	
							</div>
