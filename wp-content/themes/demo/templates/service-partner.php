...
<div class="modal" id="duplicate_product" role="dialog">
    ...
    <div class="modal-content"  style="pointer-events: auto;">
        ...
        <div class="modal-footer">
            <a href="<?php echo get_site_url().'/cart';?>" id="cartlink" style="display: none" class="btn btn-invert"><span>Cart</span></a> <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        </div>
    </div>
</div>
</div>
