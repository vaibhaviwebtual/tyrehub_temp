<?php
	...
	$SQLORDER="SELECT * FROM wp_franchises_order WHERE order_id IN ('".$order_id."')";
	$order_data=$wpdb->get_row($SQLORDER);

	$SQL="SELECT * FROM th_installer_data WHERE installer_data_id='".$order_data->franchise_id."' AND is_franchise='yes'";
...
<!--				<tr>
				...
				<tr>
				<td colspan="7" style="border: none;">
				<strong>Vehicle Detail:</strong> <?=$vehicleInfo->model_name;?>, <?=$vehicleInfo->car_number;?><br> <strong>Odo Meter-</strong><?=$vehicleInfo->odo_meter;?> <br>
