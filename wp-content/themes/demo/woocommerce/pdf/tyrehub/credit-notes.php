...
<table class="order-data-addresses">
	<tr>
		...
		<td class="address shipping-address">
			<?php if ($destination==0 && get_post_meta($order_id,'ship_to_different_address',true)==1) { ?>
		...
		<td class="order-data">
			<table>
				...
				<tr class="credit-notes-number">
					<th><?php _e( 'Credit Note No:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
					<td><?php //$this->credit_notes_number(); ?>
						<?php echo get_post_meta($order_id,'_wcpdf_credit_notes_number',true);?>
					</td>
				</tr>
				<?php } ?>
				<tr class="order-date">
					<th><?php _e( 'Credit Note Date:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
					<td><?php echo date('d-M-Y',strtotime(get_post_meta($order_id,'_wcpdf_credit_note_date_formatted',true)));?></td>
				</tr>
				<?php if ( isset($this->settings['display_number']) ) { ?>
				<tr class="invoice-number">
					<th><?php _e( 'Invoice Number:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
					<td><?php $this->invoice_number(); ?></td>
				</tr>
				<?php } ?>
				<?php if ( isset($this->settings['display_date']) ) { ?>
				<tr class="invoice-date">
					<th><?php _e( 'Invoice Date:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
					<td><?php $this->invoice_date(); ?></td>
				</tr>
				<?php } ?>
				<tr class="order-number">
					<th><?php _e( 'Order Number:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
					<td><?php $this->order_number(); ?></td>
				</tr>

				<tr class="payment-method">
					<th><?php _e( 'Payment Method:', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
...
<table class="order-details" style="font-size:12px">
	<thead>
		<tr>
			<th class="product"><?php _e('Product', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="hsn" style="text-align: center;"><?php _e('HSN / SCA', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="gst" style="text-align: center;"><?php _e('GST', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="quantity" style="text-align: center;"><?php _e('Qty', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="price" style="text-align:center;"><?php _e('Price', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="price" style="text-align:center;"><?php _e('Discount', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="price" style="text-align:center;"><?php _e('Amount', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<!-- <th class="price"><?php _e('SGST', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th>
			<th class="price"><?php _e('CGST', 'woocommerce-pdf-credit-notes-packing-slips' ); ?></th> -->
		</tr>
	</thead>
	<tbody>
