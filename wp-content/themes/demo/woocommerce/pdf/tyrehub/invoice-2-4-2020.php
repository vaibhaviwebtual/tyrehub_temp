	...
	<?php
		...
		if($user_role != 'Installer')
		{
			...
			<?php echo '<p  style="text-align:right;margin:0;padding:0"> <span class="item-name">CGST - 9% (OUTPUT)</span> </p>'; ?>
				...
				<?php echo '<p style="margin-top:30px;text-align:right"><span class="item-name">SGST - 9% (OUTPUT)  '.get_woocommerce_currency_symbol(). number_format((float)$service_gst, 2, '.', '').'</span></p>'; ?>
				<?php echo '<p  style="text-align:right;margin:0;padding:0"><span class="item-name">CGST - 9% (OUTPUT)  '.get_woocommerce_currency_symbol(). number_format((float)$service_gst, 2, '.', '').'</span></p>'; ?>
