...
<div class="woocommerce-form-login-toggle">
	<?php 
		...
		wc_print_notice( apply_filters( 'woocommerce_checkout_login_message', __( 'Existing Customer?', 'woocommerce' ) ) . ' <a href="'.$checkout_url.'/?from-checkout" class="showlogin">' . __( 'Click here to login', 'woocommerce' ) . '</a>', 'notice' ); ?>
</div>
<?php
