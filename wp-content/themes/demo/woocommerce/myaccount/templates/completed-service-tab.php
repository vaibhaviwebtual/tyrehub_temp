    ...
    while ($loop->have_posts()) {
	    ...
	    foreach ($order_items as $item_id => $item_data) {
        	...
        	if($order_prd_id == $service_voucher_prd) {
				$service_data = "SELECT * FROM th_cart_item_service_voucher WHERE product_id = '$order_prd_id' and installer_id = '$current_inst_id' and order_id = '$order_id' and status = 'completed' and paid != 'yes'  LIMIT $j,$i";
				$i++;
				$j++;
			}
		    else {
