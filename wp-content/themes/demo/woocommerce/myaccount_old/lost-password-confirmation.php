...
<?php 
    ...
    $user_login = $user->user_login;
  	...
  	$rp_link = '<a style="background: #384A94; color: #fff; padding: 10px;" href="' .get_permalink( get_option('woocommerce_myaccount_page_id'))."/lost-password/?action=rp&key=$final_key&login=" . rawurlencode($user_login) . '">Reset Password</a>';
