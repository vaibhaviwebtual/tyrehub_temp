...
<?php
	if ( ! $product_permalink ) {
		...
		if($cart_item['product_id']==get_option("balancing_alignment") || $cart_item['product_id']==get_option("car_wash")){
			echo '<p>Vehicle : '.$cart_item['variation']['vehicle_name'].'</p>';
		}
	}
	...
	if($guarantee_text != ''){
		...
		echo '<div class="guarantee-info">*Customers are responsible to claim their Tyre’s warranty directly with manufacturers</div>';
	...
	<?php
		...
		<div class="service-section">
			...
			?>		<div class="row">
						...
						<div class="col-md-12">
							<span class="selection-btn select-installer"  data-id="<?php echo $current_prd; ?>" data-vehicle="<?php echo $cart_item['custom_data']['vehicle_type']; ?>" data-cart-item-id="<?php echo $cart_item_key; ?>" data-total-qty="<?php echo $cart_item['quantity']; ?>">Select Service Partner</span>
