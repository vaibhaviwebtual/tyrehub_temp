								...
								{				
									...
									if($product_id == $service_voucher_prd)
									{
										...
										$voucher_info = "SELECT * 
									                    ...
									                    WHERE product_id = '$service_voucher_prd' AND  cart_item_key = '$cart_item_key' AND service_data_id=".$cart_item['services_name']." and session_id = '$session_id' and order_id = ''";
